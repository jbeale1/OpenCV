...
'''
USAGE: track-DH5.py [<video_source>] (180304)
Detects motion, saves center image & thumbnail
when object has moved at least X frames at V speed
'''
...
vThreshold = 1000  # how many non-zero velocity pixels for event
saveCount = 0     # how many images saved so far
vThresh= 60     # minimum "significant" velocity
show_hsv = False
show_vt = True    # display velocity threshold map
moT = 2.0         # Calc. dx/dt motion threshold for saving event
runLimit=3         # how many frames of no motion ends a run
validRunLength= 5 # how many frames of motion for good event

logFname = 'Log_DH5.txt'
fPrefix= 'DH5_'
tPrefix= 'thumbs/th5_'
thumbWidth= 120   # how many pixels wide saved thumbnail should be
# rtsp link for Dahua IP camera
vidname="rtsp://admin:123456@192.168.1.25:554/cam/realmonitor?channel=1&subtype=2" # DH5 path
...
#        flow = cv.calcOpticalFlowFarneback(prevgray, gray, None, 0.5, 3, 15, 3, 5, 1.2, 0)
        ...
        if (mCount > vThreshold): # significant motion detected this frame
          ...
          if (r < minR):
              ...
              bestImg = imgRaw
              tBest = time.localtime()
              br = cv.boundingRect(cnt) # rectangle around main contour
          #cx=0;
